...
public class MarketUI {
    ...
    private ImageView iv;
        ...
        /*
         Use player.getBalance() to showcase the person's dollars amount
         Use player.buyItem(String name) by inserting the name of one of items for sale
         Use player.sellItem(int index) by inserting the index of their inventory that they want to sell
         Use player.getMarketItems() to get items
         Market market = new Market()
         market.getSellingPrices(String name); Get price for the item
         */
