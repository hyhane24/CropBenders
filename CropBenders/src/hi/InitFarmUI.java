...
<<<<<<< HEAD
                    /*
                    I believe this is where it is going wrong but idk what to do
                     */
...
=======
                    text[i] = new Text("Empty");
                } else if (player.getPlot()[i].equals("Immature plant")) {
